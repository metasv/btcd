...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/yaochaoutokyo/btcd/connmgr)
...
```bash
$ go get -u github.com/yaochaoutokyo/btcd/connmgr
```
